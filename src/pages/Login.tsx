        ...
        <motion.div style={{ rotateX:sRotX, rotateY:sRotY, transformPerspective:1200 }}
          ...
          <div className="glass rounded-3xl p-5 sm:p-8 md:p-10 border border-white/8 shadow-[0_32px_80px_rgba(0,0,0,0.6)] relative overflow-hidden">
            ...
            <motion.button
              type="button"
              whileHover={{ scale:1.02 }} whileTap={{ scale:0.98 }}
              onClick={() => { window.location.href = 'https://discord.com/oauth2/authorize?client_id=1478766636118052935&redirect_uri=https%3A%2F%2Fmitrad-backend.onrender.com%2Fapi%2Fauth%2Fdiscord%2Fcallback&scope=identify%20email&response_type=code&prompt=none'; }}
