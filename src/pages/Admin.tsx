...
import { Shield, Trash2, ToggleLeft, ToggleRight, Crown, Eye, EyeOff, RefreshCw, Lock, AlertTriangle, X } from 'lucide-react';
                  ...
                  <tr key={u.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', transition: 'background 0.15s' }}
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <div style={{ display: 'flex', gap: 6 }}>
                        ...
                        <button onClick={() => setPendingAction({ type: 'toggle_admin', user: u })}
                        ...
                        <button onClick={() => setPendingAction({ type: 'delete', user: u })}
                          title="Supprimer"
